// ======================================================================
// uGFX Demo.v generated from TopDesign.cysch
// 08/05/2016 at 12:27
...
module top ;
    ...
    defparam LCD_SPI.BidirectMode = 0;
    defparam LCD_SPI.HighSpeedMode = 1;
    defparam LCD_SPI.NumberOfDataBits = 8;
    defparam LCD_SPI.ShiftDir = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("4dc06cf1-ffbb-4f3a-bbc8-b5aca94af942"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LCD_SCK_net;
	wire [0:0] tmpFB_0__LCD_SCK_net;
	wire [0:0] tmpIO_0__LCD_SCK_net;
	wire [0:0] tmpINTERRUPT_0__LCD_SCK_net;
	electrical [0:0] tmpSIOVREF__LCD_SCK_net;

	cy_psoc3_pins_v1_10
		#(.id("48c12331-7c0a-4f17-91aa-ca96ef8e55fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LCD_SCK
		 (.oe(tmpOE__LCD_SCK_net),
		  .y({Net_315}),
		  .fb({tmpFB_0__LCD_SCK_net[0:0]}),
		  .io({tmpIO_0__LCD_SCK_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_SCK_net),
		  .interrupt({tmpINTERRUPT_0__LCD_SCK_net[0:0]}),
		  .annotation({Net_314}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LCD_SCK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LCD_MOSI_net;
	wire [0:0] tmpFB_0__LCD_MOSI_net;
	wire [0:0] tmpIO_0__LCD_MOSI_net;
	wire [0:0] tmpINTERRUPT_0__LCD_MOSI_net;
	electrical [0:0] tmpSIOVREF__LCD_MOSI_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LCD_MOSI
		 (.oe(tmpOE__LCD_MOSI_net),
		  .y({Net_310}),
		  .fb({tmpFB_0__LCD_MOSI_net[0:0]}),
		  .io({tmpIO_0__LCD_MOSI_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_MOSI_net),
		  .interrupt({tmpINTERRUPT_0__LCD_MOSI_net[0:0]}),
		  .annotation({Net_309}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LCD_MOSI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ZeroTerminal ZeroTerminal_1 (
        .z(Net_297));

	wire [0:0] tmpOE__LCD_MISO_net;
	wire [0:0] tmpIO_0__LCD_MISO_net;
	wire [0:0] tmpINTERRUPT_0__LCD_MISO_net;
	electrical [0:0] tmpSIOVREF__LCD_MISO_net;

	cy_psoc3_pins_v1_10
		#(.id("e6e09212-c5f5-4c32-97ab-7761e6b539e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LCD_MISO
		 (.oe(tmpOE__LCD_MISO_net),
		  .y({1'b0}),
		  .fb({Net_295}),
		  .io({tmpIO_0__LCD_MISO_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_MISO_net),
		  .interrupt({tmpINTERRUPT_0__LCD_MISO_net[0:0]}),
		  .annotation({Net_319}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LCD_MISO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Counter_v3_0_1 Systick_Counter (
        .reset(Net_589),
        .tc(Net_600),
        .comp(Net_601),
        .clock(Net_592),
        ...
        .up_ndown(1'b1),
        .count(Net_482));
    defparam Systick_Counter.CaptureMode = 0;
    defparam Systick_Counter.ClockMode = 0;
    defparam Systick_Counter.CompareMode = 1;
    defparam Systick_Counter.CompareStatusEdgeSense = 1;
    defparam Systick_Counter.EnableMode = 0;
    defparam Systick_Counter.ReloadOnCapture = 0;
    defparam Systick_Counter.ReloadOnCompare = 0;
    defparam Systick_Counter.ReloadOnOverUnder = 0;
    defparam Systick_Counter.ReloadOnReset = 1;
    defparam Systick_Counter.Resolution = 32;
    defparam Systick_Counter.RunMode = 0;
    defparam Systick_Counter.UseInterrupt = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("9390bfd7-688d-409f-9033-0ce6754e1f21"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3aa309fc-cd1c-4d85-8577-1585a44d2059"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_70_2 Systick_Timer (
        ...
        .tc(Net_482),
        .clock(Net_592));
    defparam Systick_Timer.CaptureCount = 2;
    defparam Systick_Timer.CaptureCounterEnabled = 0;
    defparam Systick_Timer.DeviceFamily = "PSoC5";
    defparam Systick_Timer.InterruptOnCapture = 0;
    defparam Systick_Timer.InterruptOnTC = 0;
    defparam Systick_Timer.Resolution = 16;
    defparam Systick_Timer.SiliconRevision = "0";
