...
*/
     ...
     *  @{
     */
        #define LCD_CS_INTR_NONE      (uint16)(0x0000u)
        #define LCD_CS_INTR_RISING    (uint16)(0x0001u)
        #define LCD_CS_INTR_FALLING   (uint16)(0x0002u)
        #define LCD_CS_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define LCD_CS_INTR_MASK      (0x01u) 
#endif /* (LCD_CS__INTSTAT) */
...
/* SIO registers */
#if defined(LCD_CS__SIO_CFG)
    #define LCD_CS_SIO_HYST_EN        (* (reg8 *) LCD_CS__SIO_HYST_EN)
    #define LCD_CS_SIO_REG_HIFREQ     (* (reg8 *) LCD_CS__SIO_REG_HIFREQ)
    #define LCD_CS_SIO_CFG            (* (reg8 *) LCD_CS__SIO_CFG)
    #define LCD_CS_SIO_DIFF           (* (reg8 *) LCD_CS__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define LCD_CS_0_INTTYPE_REG 		(* (reg8 *) LCD_CS__0__INTTYPE)
#endif /* (LCD_CS__INTSTAT) */
